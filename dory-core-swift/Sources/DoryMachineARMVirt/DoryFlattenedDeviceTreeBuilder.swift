/// Minimal flattened device-tree writer for the version 17 binary format.
public final class DoryFlattenedDeviceTreeBuilder {
  ...
  private static let propertyToken: UInt32 = 3
  ...
  public func property(_ name: String, bytes: [UInt8]) {
    ...
    appendToken(Self.propertyToken)
