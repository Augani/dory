...
private func jitDiagnostics(_ diagnostics: DoryPCJITCacheStatistics?) -> Any {
  ...
  return [
    ...
    "chainTargetLegacyToTier1Rejections": diagnostics.chainTargetLegacyToTier1Rejections,
    "chainTargetTier1ToLegacyRejections": diagnostics.chainTargetTier1ToLegacyRejections,
    "chainTargetOtherCompilerABIRejections": diagnostics.chainTargetOtherCompilerABIRejections,
