...
public enum DoryDeviceTelemetryMetricKind: String, Codable, Sendable, CaseIterable, Hashable {
    ...
    case displayVisibleFrames = "display-visible-frames"
    ...
    case graphicsCommands = "graphics-commands"
    case graphicsCommandFailures = "graphics-command-failures"
    case graphicsDeviceLosses = "graphics-device-losses"
    case guestInstructions = "guest-instructions"
    case interpreterInstructions = "interpreter-instructions"
    case baselineJITInstructions = "baseline-jit-instructions"
    case baselineJITBlocks = "baseline-jit-blocks"
    case optimizingJITInstructions = "optimizing-jit-instructions"
    case optimizingJITBlocks = "optimizing-jit-blocks"
    case nativeReadTLBHits = "native-read-tlb-hits"
    case nativeReadTLBMisses = "native-read-tlb-misses"
    case nativeReadSlowPaths = "native-read-slow-paths"
