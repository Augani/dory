...
@Suite("Creation artifact verification handoff")
struct DoryMachineCreationArtifactProofTests {
    ...
    func boundedVerification() throws {
        ...
        let proof = try DoryMachineCreationArtifactProof(configuration: fixture.machine, evidence: fixture.evidence, hash: hash)
        #expect(hashes == 2)
        for _ in 0..<8 { try proof.validate(configuration: fixture.machine, evidence: fixture.evidence) }
        #expect(hashes == 2)
        _ = try DoryMachineCreationArtifactProof(configuration: fixture.machine, evidence: fixture.evidence, hash: hash)
        #expect(hashes == 4)
    ...
    func rejectsMutation(mutation: String) throws {
        let fixture = try ArtifactProofFixture()
        defer { fixture.cleanup() }
        let proof = try DoryMachineCreationArtifactProof(configuration: fixture.machine,
    ...
    func rejectsMutationDuringHash() throws {
        ...
        #expect(throws: (any Error).self) {
            try DoryMachineCreationArtifactProof(configuration: fixture.machine, evidence: fixture.evidence) { descriptor in
