...
struct PVHRunnerConfiguration: Codable, Sendable {
  ...
  static let usage = """
    ...
    No raw predictor mode has retained repeated exact-candidate Linux guest acceptance. Use none
    for correctness campaigns; every other mode is an explicit engineering experiment and cannot
    close a qualification gate.
  ...
  init(_ source: DoryPCJITCacheStatistics) {
    self.init(
      cumulativeCounters: [
        ...
        "optimizingCompilationAttempts": source.optimizingCompilationAttempts,
        "lookupVisibleOptimizedBlocks": source.lookupVisibleOptimizedBlocks,
        "lookupVisibleChangedOptimizedBlocks": source.lookupVisibleChangedOptimizedBlocks,
        "publishedPropagatedConstants": source.publishedPropagatedConstants,
        "publishedEliminatedStatements": source.publishedEliminatedStatements,
        ...
        "chainTargetAttempts": source.chainTargetAttempts,
        "chainTargetAccepts": source.chainTargetAccepts,
        "chainTargetSourceShapeRejections": source.chainTargetSourceShapeRejections,
        "chainTargetBoundaryRejections": source.chainTargetBoundaryRejections,
        "chainTargetRestartableWriterRejections": source.chainTargetRestartableWriterRejections,
        "chainTargetMissingMemoryRejections": source.chainTargetMissingMemoryRejections,
        "chainTargetInterpreterGuardRejections": source.chainTargetInterpreterGuardRejections,
        "chainTargetCompilerABIRejections": source.chainTargetCompilerABIRejections,
        "chainTargetPublicationRejections": source.chainTargetPublicationRejections,
