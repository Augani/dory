  ...
  init(_ source: DoryPCJITCacheStatistics) {
    self.init(
      cumulativeCounters: [
        ...
        "chainTargetLegacyToTier1Rejections": source.chainTargetLegacyToTier1Rejections,
        "chainTargetTier1ToLegacyRejections": source.chainTargetTier1ToLegacyRejections,
        "chainTargetOtherCompilerABIRejections": source.chainTargetOtherCompilerABIRejections,
