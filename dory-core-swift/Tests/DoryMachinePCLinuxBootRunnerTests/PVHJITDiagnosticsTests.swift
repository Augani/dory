...
@Suite struct PVHJITDiagnosticsTests {
  ...
  @Test func serializationRetainsCountersAndCapsSitesWithConfirmedInstructionBytes() throws {
    let counterNames = [
      ...
      "optimizingCompilationAttempts", "lookupVisibleOptimizedBlocks",
      "lookupVisibleChangedOptimizedBlocks", "publishedPropagatedConstants",
      "publishedEliminatedStatements",
