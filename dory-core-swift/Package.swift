...
let package = Package(
  ...
  products: [
    ...
    .library(name: "DoryHostDeviceBroker", targets: ["DoryHostDeviceBroker"]),
  ...
  targets: [
    ...
    .executableTarget(name: "dory-x86-throughput-benchmark", dependencies: ["DoryDBTX86"]),
    .executableTarget(
      name: "dory-x86-decode-audit",
    ...
    .executableTarget(
      ...
      dependencies: ["DoryDBTX86", "DoryMachinePC", "DoryPCQualification", "DoryVirtio"],
