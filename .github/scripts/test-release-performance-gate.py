#!/usr/bin/env python3
"""Non-mutating arming tests for exact-candidate performance qualification."""
...
GATE = ROOT / "scripts" / "qualify-release-performance.sh"
...
class ReleasePerformanceGateTests(unittest.TestCase):
    ...
    def test_explicit_clean_account_arming_precedes_host_or_filesystem_mutation(self) -> None:
        with tempfile.TemporaryDirectory(prefix="dory-performance-gate-test.") as raw:
            ...
            candidate.mkdir()
            workroot = temporary / "dory-release-performance"
    ...
    def test_candidate_and_workroot_authorities_reject_indirection_or_overlap(self) -> None:
        with tempfile.TemporaryDirectory(prefix="dory-performance-gate-test.") as raw:
            ...
            indirect = self.invoke(
                candidate_link,
                temporary / "dory-release-performance",
                temporary,
            )
            ...
            parent = temporary / "dory-release-performance"
        ...
        self.assertIn("dedicated dory-release-performance name", wrong_name.stdout)
