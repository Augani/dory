...
- **x86 VM performance:** reduce measured timer/interrupt-path interpreter fallbacks, preserve precise faults and debug behavior, then rerun ordinary UEFI boot through the production runner. [Bounded clock comparisons](docs/virtualization/evidence/p06-pc-2026-09-05/clock-source-comparison.json) do not establish a clock fix or usable boot performance.
