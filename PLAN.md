...
The pinned x86_64 Mesa VirGL2 runtime now builds with a matching GLX loader, Gallium library and virtio-gpu DRI driver. Archive, source, dependency and ELF checks pass ([build evidence](docs/virtualization/evidence/p06-pc-2026-09-05/mesa-virgl2-build.json)). This establishes a guest runtime package only: immutable kernel/rootfs/Mesa binding and a real guest GLX workload remain required before PC GPU admission can open.
