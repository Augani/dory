...
Implementation checkpoint: `a10167e67` on 2026-09-20. This document is a source inventory and
...
- The complete PC target passes 441 tests across 56 Swift Testing suites in debug and optimized
...
- The complete current 441-test PC target passes under Thread Sanitizer with no race report. This
