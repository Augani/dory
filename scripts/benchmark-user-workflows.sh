...
proc_pattern() {
  case "$1" in
    dory) echo "${DORY_PROCESS_PATTERN:-/Applications/Dory[.]app/Contents/(MacOS/Dory|Helpers/(doryd|dory-vmm|gvproxy|DoryHVRunner[.]app/Contents/MacOS/dory-hv))}" ;;
...
capture_run_provenance() {
  ...
  for rel in \
    Contents/MacOS/Dory \
    Contents/Helpers/DoryHVRunner.app/Contents/MacOS/dory-hv \
