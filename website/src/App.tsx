    ...
    >
      ...
      <div className="demo-app">
        <aside className="demo-sidebar">
          <div className="demo-brand"><img src="./logo.svg" alt="" /><span><strong>Dory</strong><small>v0.4.0 · Engine running</small></span></div>
      ...
      <main id="top">
        <section className="hero">
          ...
          <div className="hero-content">
            <div className="release-pill">
              <span /> Dory 0.4.0 · Focused components
        ...
        <section className="download-section section" id="download">
          <div className="section-heading centered">
            ...
            <p>Dory 0.4.0 uses one Docker Core app with signed, removable components. See the exact total before downloading.</p>
          </div>
