...
description: >
  Video-first companion to Capsule's design.md. The unit is the frame (1080×1080). Atoms are
...
unit: the frame — 1080×1080 square primary; 16:9 and 9:16 adaptations documented
...
typography:
  ...
  label:     { fontFamily: "Manrope", px: 14, weight: 600, tracking: "0.1em", upper: true }
...
- **Fonts** — already set to **Manrope** (display) / **SF Mono** (body); ignore any preset font name lingering in prose.
- **Weights** — the brand font ships `{300, 400, 600, 700, 800}` only; every weight is clamped to these — ignore higher preset weights (e.g. 600/700) in prose.
...
- **Primary:** 1080×1080 (1:1). Display authored in **`cqw`** (`px ÷ 1080 × 100 = cqw`).
- **Landscape adaptation:** 1920×1080 (16:9). **Vertical adaptation:** 1080×1920 (9:16).
