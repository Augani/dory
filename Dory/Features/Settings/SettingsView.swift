...
struct SettingsView: View {
    ...
    private var general: some View {
        ...
        return VStack(alignment: .leading, spacing: 0) {
            ...
            VStack(spacing: 0) {
                ...
                toggleRow("Keep engine running after quit", "Always on — the engine and virtual machines run independently from the Dory window.", isOn: .constant(true), divider: true, disabled: true)
    ...
    private var machines: some View {
        VStack(alignment: .leading, spacing: 22) {
            ...
            VStack(spacing: 0) {
                machinePolicyRow("Desktop VMs", "Interactive Linux and macOS virtual machines for desktop applications. They have a display and are managed by the user.", divider: true)
