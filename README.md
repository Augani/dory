...
> Dory 0.4.4 is one smaller Docker Core app with optional, signed Kubernetes, Linux Machines,
...
Start with the one Apple Silicon [Dory 0.4.4 Docker Core
DMG](https://github.com/Augani/dory/releases/download/v0.4.4/Dory-0.4.4-arm64.dmg). The signed
