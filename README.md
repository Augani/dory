...
> Dory 0.4.0 is one smaller Docker Core app with optional, signed Kubernetes, Linux Machines,
...
Start with the one Apple Silicon [Dory 0.4.0 Docker Core
DMG](https://github.com/Augani/dory/releases/download/v0.4.0/Dory-0.4.0-arm64.dmg). The signed
