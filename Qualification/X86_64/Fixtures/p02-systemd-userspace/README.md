...
shellcheck -x -s sh Qualification/X86_64/Fixtures/p02-systemd-userspace/common \
  Qualification/X86_64/Fixtures/p02-systemd-userspace/workload \
  Qualification/X86_64/Fixtures/p02-systemd-userspace/receipt
```
