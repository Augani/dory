...
install_fex() {
  ...
  require_file_hash "$vendor/FEX" 3f6e1a5ab3ae4d164573ee1ad381afff1670e9b124c0556e53101f025a74c134
  ...
  require_file_hash "$bundle/FEX" 3f6e1a5ab3ae4d164573ee1ad381afff1670e9b124c0556e53101f025a74c134
  ...
  package_manifest_hash="$(sha256_file "$bundle/provenance/BUILD_PACKAGES.txt")"
  {
    ...
    echo "Dory complete signal-context restore patch SHA-256 e06507751d42ff359b2257d413fc07d145483e4739b286596c1e12d6dde45e90"
