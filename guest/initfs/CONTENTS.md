...
- FEX-Emu 2607 commit `1cc4b93e7a71c883ec021b71359f136394dc1f3c`, Dory's
  hash-locked container-FD isolation patch, and its private pinned Ubuntu Noble runtime on `arm64`
...
- `/usr/lib/dory/fex`: the directly private-linked, read-only FEX runtime, loader/libraries,
  configuration data, source/build provenance, and redistribution notices used for seccomp-correct
